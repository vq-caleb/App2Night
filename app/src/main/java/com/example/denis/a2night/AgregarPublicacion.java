 ...
 */
public class AgregarPublicacion extends Fragment {
    ...
    private void agregarProducto(final String nombre2, String precio2) {
        myRef = db.getReference().child("Publicaciones");
        Publicacion publicacion = new Publicacion(aGlobal.getIdEmpresaActual(), "", "publicaciones/" + aGlobal.getIdEmpresaActual() + "/publicacion4", "12 horas", aGlobal.getIdEmpresaActual(), "Evento nocturno");
        myRef.child("publicacion4").setValue(publicacion);
    ...
    public void uploadImage() {
        ...
        imageRef = storageRef.child("publicaciones/"+aGlobal.getIdEmpresaActual()+"/"+"publicacion4");
        /*myRef = db.getReference().child("Publicaciones").child(aGlobal.getIdEmpresaActual());
        String img = "publicaciones/"+aGlobal.getIdEmpresaActual()+"/"+"publicacion4";
        myRef.child("publicacion").setValue(img);*/
